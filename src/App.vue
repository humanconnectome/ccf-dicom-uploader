  ...
  <div class="wrapper">
    ...
    <div class="footer">
      <div class="uk-align-left" style="margin: 5px">
        ...
        <button
          ...
          uk-toggle="target: #questions-modal"
          style="width:20px"
        >
          <i
            class="fa fa-question fa-2x"
            aria-hidden="true"
            style="position:relative; top:5px; left:-10px; color:gray"
          ></i>
        </button>
      </div>
      <div class="uk-align-right" style="margin: 5px">
        <button
          class="uk-button uk-button-danger app-button"
          style="width:110px"
          @click="exit"
        >
          Exit
        ...
        <button
          ...
          id="back-btn"
          style="width:110px"
          v-bind:disabled="this.$route.name === 'servers'"
          @click="back"
        >
          Back
        </button>
    ...
    <div id="questions-modal" uk-modal>
      <div class="uk-modal-dialog uk-modal-body">
        ...
        <p>
          If you have any questions or find any bugs in the uploader, please
          contact
